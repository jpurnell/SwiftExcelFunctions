...
public struct FunctionRegistry: Sendable {
    ...
    public static func makeBuiltin() -> FunctionRegistry {
        ...
        let allCategories: [[ExcelFunction]] = [
            ...
            BuiltinOddPeriodBonds.all,
            BuiltinMatrixAndSeries.all,
            BuiltinCashflowAndDepreciation.all,
            BuiltinLeftTailDistributions.all,
            ...
            BuiltinRiskSolverProperties.all,
            BuiltinRiskSolverForecast.all,
            BuiltinGroupBy.all,
